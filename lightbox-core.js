...
// --- START: Everything inside the DOMContentLoaded listener ---
window.addEventListener('DOMContentLoaded', () => {

  // 🚨 START THE DYNAMIC CONTENT PROCESS 🚨
  // This executes the async fetch and renders the HTML grid using the function from dynamic-api.js
  if (typeof initializeDynamicContent === 'function') {
      initializeDynamicContent();
  } else {
      console.error("Initialization failed: dynamic-api.js or initializeDynamicContent is missing.");
  }
  ...
  // --- HELPERS (Your Original Lightbox Logic) ---
